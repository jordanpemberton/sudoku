...
This program generates, solves, and allows users to play Sudoku on boards of size 4 x4, 9 x 9, or 16 x 16.  (Be aware that 16 x 16 boards might be somewhat slow to generate.)
